...
#import "VFChangeHobbyViewController.h"

@interface VFChangeHobbyViewController ()

@property (nonatomic, strong) UITextField *textField;

@end

@implementation VFChangeHobbyViewController
...
- (void)setupView {
    ...
    if (self.hobby)
    {
        self.textField.text = [NSString stringWithFormat:@"%@",self.hobby];
    }
