...
@interface VFChooseUseCarUserView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation VFChooseUseCarUserView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    VFUseCarUseeListModel *model = [[VFUseCarUseeListModel alloc]initWithDic:_dataArr[indexPath.row]];
    cell.textLabel.text = model.nick_name;
    cell.detailTextLabel.text = model.mobile;
    if ([model.nick_name isEqualToString:@""]) {
        cell.textLabel.text = @"  ";
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(chooseUseCarUeserClick:)]) {
        VFUseCarUseeListModel *model = [[VFUseCarUseeListModel alloc]initWithDic:_dataArr[indexPath.row]];
        [self.delegate chooseUseCarUeserClick:model];
        [self animateOut];
    }
}
