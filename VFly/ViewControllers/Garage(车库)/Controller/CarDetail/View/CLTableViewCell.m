...
- (UIButton *) button{
    if (_button == nil){
        ...
        [_button setBackgroundImage:[UIImage imageNamed:@"icon_vedeo"] forState:UIControlStateNormal];
...
- (UIImageView *) pictureView{
    if (_pictureView == nil){
        _pictureView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 0, kScreenW-30,(kScreenW-30)*kPicZoom)];
...
- (CGFloat)cellOffset{
    ...
    CGFloat offset       = - offsetDig * ((kScreenW-30)*kPicZoom - (kScreenW-30)*kPicZoom) / 2;
...
-(void)layoutSubviews{
    ...
    _pictureView.CLwidth  = kScreenW-30;
    _pictureView.CLheight = (kScreenW-30)*kPicZoom;
}
