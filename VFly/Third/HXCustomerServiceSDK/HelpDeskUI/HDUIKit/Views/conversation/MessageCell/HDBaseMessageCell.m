...
//        _nameLabel.text = _lgM.nickname;
        ...
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:[[NSUserDefaults standardUserDefaults] objectForKey:kHeadImage]]];
        ...
        [self avatarViewImage:model];
        self.avatarView.image = [UIImage imageNamed:@"客服默认头像2"];
    }
