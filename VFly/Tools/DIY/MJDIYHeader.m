...
//
    // logo
    UIImageView *logo = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"HUDLogo"]];
...
//    _aniView.frame = CGRectMake(0, 0, self.bounds.size.width, 50);
//    self.label.frame = self.bounds;
//
    self.logo.bounds = CGRectMake(0, 0, self.bounds.size.width, 25);
    self.logo.center = CGPointMake(self.mj_w * 0.5, - 25);
//
//    self.loading.center = CGPointMake(self.mj_w * 0.5, self.mj_h * 0.5);
    self.loading.frame = CGRectMake(0, 0, self.bounds.size.width, 30);
}
